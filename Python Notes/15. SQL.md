...
SQL is the language used to create/modify and extract data from a relational database. A relational database is a collection of data organized into tables (of rows and columns/fields)
...
FROM people;
●	Selecting multiple columns in the people table
...
As you can see, IS NULL is useful when combined with WHERE to figure out what data you're
missing.
