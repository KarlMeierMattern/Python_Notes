...
## Regression  
- Linear regression assumes normally distributed residuals. This assumption can be aided by transforming the y variable.  
...
- This line minimises the loss function.  
- Modelling best practice:  
1. Use cost function to fit model;  
2. Develope multiple models; and  
...
- L2 norm/loss function: sum of squared differences between predicted value yb and true y.  
...
- *Note*: the L1 norm/loss function is the sum of the absolute differences between predicted yb and true y. This is used in L1 regularisation (Lasso), which encourages sparsity in ML models by adding the L1 norm of the model weights to the loss function.  
...
- (R^2): 1-(SSE/TSS). (One minus the unexplained variation divided by the total variation).  
