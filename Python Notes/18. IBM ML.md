...
- Parameters are represented by omega. We find the best parameters by looking at past experience. Parameters define the relationship between the features (x) and the outcome (y).  
